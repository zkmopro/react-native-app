...
function uniffiEnsureInitialized() {
    ...
    if (nativeModule().ubrn_uniffi_mopro_example_app_checksum_func_generate_noir_proof() !== 27260) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_mopro_example_app_checksum_func_generate_noir_proof");
    }
    if (nativeModule().ubrn_uniffi_mopro_example_app_checksum_func_get_noir_verification_key() !== 19747) {
    ...
    if (nativeModule().ubrn_uniffi_mopro_example_app_checksum_func_verify_noir_proof() !== 56869) {
