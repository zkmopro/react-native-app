...
@ReactModule(name = MyTestLibraryModule.NAME)
class MyTestLibraryModule(reactContext: ReactApplicationContext) :
  NativeMyTestLibrarySpec(reactContext) {
  ...
  companion object {
    const val NAME = "MyTestLibrary"

    init {
      System.loadLibrary("my-test-library")
    }
  }
}