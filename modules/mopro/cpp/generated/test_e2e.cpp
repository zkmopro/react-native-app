...
RustBuffer uniffi_test_e2e_fn_func_greet(RustBuffer name,
                                         RustCallStatus *uniffi_out_err);
RustBuffer uniffi_test_e2e_fn_func_hello_uniffi(RustCallStatus *uniffi_out_err);
RustBuffer ffi_test_e2e_rustbuffer_alloc(uint64_t size,
                                         RustCallStatus *uniffi_out_err);
RustBuffer ffi_test_e2e_rustbuffer_from_bytes(ForeignBytes bytes,
                                              RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rustbuffer_free(RustBuffer buf,
                                  RustCallStatus *uniffi_out_err);
RustBuffer ffi_test_e2e_rustbuffer_reserve(RustBuffer buf, uint64_t additional,
                                           RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_test_e2e_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_test_e2e_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_test_e2e_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_test_e2e_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_test_e2e_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_test_e2e_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_test_e2e_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_test_e2e_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_test_e2e_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_f64(
    /*handle*/ uint64_t handle);
double ffi_test_e2e_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_test_e2e_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_test_e2e_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_test_e2e_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_test_e2e_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_test_e2e_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint16_t uniffi_test_e2e_checksum_func_greet();
uint16_t uniffi_test_e2e_checksum_func_hello_uniffi();
uint32_t ffi_test_e2e_uniffi_contract_version();
}

namespace uniffi::test_e2e {
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::test_e2e::Bridging<T>::fromJs(rt, callInvoker, pointee);
    }
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_test_e2e_rustbuffer_alloc(size, &status);
  }

  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    ffi_test_e2e_rustbuffer_free(buf, &status);
  }

  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    return ffi_test_e2e_rustbuffer_from_bytes(bytes, &status);
  }
...
namespace uniffi::test_e2e::registry {
...
// Callback function:
// uniffi::test_e2e::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
namespace uniffi::test_e2e::cb::rustfuturecontinuationcallback {
using namespace facebook;
...
makeCallbackFunction( // uniffi::test_e2e::cb::rustfuturecontinuationcallback
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
// This method is called from the destructor of NativeTestE2e, which only
...
// Callback function:
// uniffi::test_e2e::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::test_e2e::st::foreignfuture::foreignfuture::free {
using namespace facebook;
...
makeCallbackFunction( // uniffi::test_e2e::st::foreignfuture::foreignfuture::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::test_e2e::st::foreignfuture::foreignfuture::free::
...
template <> struct Bridging<UniffiForeignFutureStructU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status = uniffi::test_e2e::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructU8>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteI8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructI8>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructU16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructI16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructU32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructI32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructU64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructI64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructF32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructF64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompletePointer> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructPointer>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureStructRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    // Create the vtable from the js callbacks.
    rsObject.return_value = uniffi::test_e2e::Bridging<RustBuffer>::fromJs(
        rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status = uniffi::test_e2e::Bridging<RustCallStatus>::fromJs(
        rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
template <> struct Bridging<UniffiForeignFutureCompleteRustBuffer> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    func(
        ...
        uniffi::test_e2e::Bridging<UniffiForeignFutureStructRustBuffer>::fromJs(
            rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteVoid> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::test_e2e::Bridging<UniffiForeignFutureStructVoid>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &value) {
    try {
      return uniffi::test_e2e::cb::rustfuturecontinuationcallback::
...
NativeTestE2e::NativeTestE2e(
  ...
  props["ubrn_uniffi_test_e2e_fn_func_greet"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_test_e2e_fn_func_greet"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_test_e2e_fn_func_greet(rt, thisVal, args,
                                                           count);
          });
  props["ubrn_uniffi_test_e2e_fn_func_hello_uniffi"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_test_e2e_fn_func_hello_uniffi"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_test_e2e_fn_func_hello_uniffi(rt, thisVal,
                                                                  args, count);
          });
  props["ubrn_uniffi_test_e2e_checksum_func_greet"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt,
                                    "ubrn_uniffi_test_e2e_checksum_func_greet"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_test_e2e_checksum_func_greet(rt, thisVal,
                                                                 args, count);
          });
  props["ubrn_uniffi_test_e2e_checksum_func_hello_uniffi"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_test_e2e_checksum_func_hello_uniffi"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_test_e2e_checksum_func_hello_uniffi(
                rt, thisVal, args, count);
          });
  props["ubrn_ffi_test_e2e_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_ffi_test_e2e_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_test_e2e_uniffi_contract_version(rt, thisVal,
                                                                  args, count);
          });
}

void NativeTestE2e::registerModule(
    jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
  auto invoker =
      std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
  auto tm = std::make_shared<NativeTestE2e>(rt, invoker);
  auto obj = rt.global().createFromHostObject(rt, tm);
  rt.global().setProperty(rt, "NativeTestE2e", obj);
}

void NativeTestE2e::unregisterModule(jsi::Runtime &rt) {
  uniffi::test_e2e::registry::clearRegistry();
}

jsi::Value NativeTestE2e::get(jsi::Runtime &rt, const jsi::PropNameID &name) {
  try {
...
std::vector<jsi::PropNameID> NativeTestE2e::getPropertyNames(jsi::Runtime &rt) {
...
void NativeTestE2e::set(jsi::Runtime &rt, const jsi::PropNameID &name,
                        const jsi::Value &value) {
...
NativeTestE2e::~NativeTestE2e() {
  ...
  uniffi::test_e2e::cb::rustfuturecontinuationcallback::cleanup();
  // Cleanup for "free" callback function CallbackInterfaceFree
  uniffi::test_e2e::st::foreignfuture::foreignfuture::free::cleanup();
}

// Utility functions for serialization/deserialization of strings.
jsi::Value
NativeTestE2e::cpp_uniffi_internal_fn_func_ffi__string_to_byte_length(
...
jsi::Value
NativeTestE2e::cpp_uniffi_internal_fn_func_ffi__string_to_arraybuffer(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value
NativeTestE2e::cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value NativeTestE2e::cpp_uniffi_test_e2e_fn_func_greet(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::test_e2e::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_test_e2e_fn_func_greet(
      uniffi::test_e2e::Bridging<RustBuffer>::fromJs(rt, callInvoker, args[0]),
      &status);
  uniffi::test_e2e::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);

  return uniffi::test_e2e::Bridging<RustBuffer>::toJs(rt, callInvoker, value);
}
jsi::Value NativeTestE2e::cpp_uniffi_test_e2e_fn_func_hello_uniffi(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::test_e2e::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_test_e2e_fn_func_hello_uniffi(&status);
  uniffi::test_e2e::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);

  return uniffi::test_e2e::Bridging<RustBuffer>::toJs(rt, callInvoker, value);
}
jsi::Value NativeTestE2e::cpp_uniffi_test_e2e_checksum_func_greet(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = uniffi_test_e2e_checksum_func_greet();

  return uniffi_jsi::Bridging<uint16_t>::toJs(rt, callInvoker, value);
}
jsi::Value NativeTestE2e::cpp_uniffi_test_e2e_checksum_func_hello_uniffi(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = uniffi_test_e2e_checksum_func_hello_uniffi();

  return uniffi_jsi::Bridging<uint16_t>::toJs(rt, callInvoker, value);
}
jsi::Value NativeTestE2e::cpp_ffi_test_e2e_uniffi_contract_version(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = ffi_test_e2e_uniffi_contract_version();
